...
class Naive_Ea(object):
    """
    This class is used to represent a ea procedure.
    When get the params, this class can begin the
    ea procedure to solve the problem.
    """
    ...
    def save(self, filename, output_dir, population, max_gen):
        """
        :param filename: the filename to be saved in
        :param output_dir: the dir to be saved in
        :param population: the population to be saved
        :param max_gen: the max generation of the ea procedure
        """
        ...
        with open(os.path.join(output_dir, filename), "w") as f:
            ...
            record = {
                ...
                "best_ones": best_ones #save_best_ones
            }
            json.dump(record, f, indent=4)

    def _for_grid(self, filename, output_dir, population):
        """
        File saving function for Grid Search.
        """
